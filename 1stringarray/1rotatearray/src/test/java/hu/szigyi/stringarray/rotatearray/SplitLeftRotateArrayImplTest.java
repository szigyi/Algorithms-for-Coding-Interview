...
public class SplitLeftRotateArrayImplTest {
    ...
    public SplitLeftRotateArrayImplTest(int rotateBy, int[] inputArray, int[] expectedArray) {
    ...
    public void setUp() throws Exception {
        rotateArray = new SplitLeftRotateArrayImpl();
    }
