...
public class SplitRightRotateArrayImplTest {
    ...
    public SplitRightRotateArrayImplTest(int rotateBy, int[] inputArray, int[] expectedArray) {
    ...
    public void setUp() throws Exception {
        rotateArray = new SplitRightRotateArrayImpl();
    }
