...
public class ScanSumInArrayImplTest {
    ...
    public static Iterable<Object[]> data() {
        return Arrays.asList(new Object[][] {
                ...
                // Array should be sorted, so the Scan solution can not handle this case
    ...
    public ScanSumInArrayImplTest(int[] expected, int[] array, int target) {
    ...
    public void setUp() throws Exception {
        sumInArray = new ScanSumInArrayImpl();
    }
