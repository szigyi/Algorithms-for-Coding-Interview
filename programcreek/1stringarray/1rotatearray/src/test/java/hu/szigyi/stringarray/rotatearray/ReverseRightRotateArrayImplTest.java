...
public class ReverseRightRotateArrayImplTest {
    ...
    public static Iterable<Object[]> data() {
        return Arrays.asList(new Object[][] {
                ...
                { 4, new int[]{1, 2, 3, 4, 5, 6}, new int[]{3, 4, 5, 6, 1, 2} },
                { 4, new int[]{1, 2, 3, 4, 5, 6, 7}, new int[]{4, 5, 6, 7, 1, 2, 3} },
    ...
    public ReverseRightRotateArrayImplTest(int rotateBy, int[] inputArray, int[] expectedArray) {
    ...
    public void setUp() throws Exception {
        rotateArray = new ReverseRightRotateArrayImpl();
    }
